...
-- Sample data insertion (use only for dev)
INSERT OR IGNORE INTO clients (id, enseigne, magasin, contact, email_compta) VALUES
('C001','Intermarché','Paris 15','Jean Dupont','razmotebr@hotmail.fr'),
('C002','Carrefour','Nice Gambetta','Sophie Martin','razmotebr@hotmail.fr');

INSERT OR IGNORE INTO produits (id, nom) VALUES
(1,'Film alimentaire 450 mm'),
(2,'Film alimentaire 300 mm'),
(3,'Ticket Linerless 58mm x 65M ø40mm BL'),
(4,'Ticket Linerless 58mm x 65M ø40mm BL x30'),
(5,'Étiquettes thermo 58×43');
